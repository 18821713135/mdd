		...
		<div class="search">
			<form action="http://localhost:8085/search.html?keyword=" id="searchForm"
				...
				<input type="text" class="text keyword ac_input" name="keyword"
					...
					style="background-color: #dd00a7;width:80px;font:bold 18px Microsoft Yahei;border-radius:0%;text-align:center;padding:0px;line-height:10px;" onclick="search_keys('searchForm')">
			</form>
